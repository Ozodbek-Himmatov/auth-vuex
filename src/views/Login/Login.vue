  ...
  <div class="bg--500">
              ...
              <form>
                <div>
                  ...
                  <input
                    ...
                    v-model="username"
                    id="text"
                    placeholder="Toshmatov G'ishmat"
                  />
                </div>
                <div class="mt-8">
    ...
    <!-- <section class="bg-gray-700 dark:bg-gray-900">
      ...
      >
        ...
        <div
          class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-green-400 dark:bg-gray-800 dark:border-gray-700"
        >
